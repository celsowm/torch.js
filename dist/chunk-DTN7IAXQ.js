...
// src/vendor/pickleparser/src/reader.ts
var BufferReader = class {
  _buffer;
  _dataView;
  _utf8Decoder = new TextDecoder("utf-8");
  _asciiDecoder = new TextDecoder("ascii");
  _position;
  constructor(buffer) {
    this._buffer = buffer;
  ...
  skip(offset) {
    ...
    if (this._position > this._buffer.length) {
      throw new Error(
        "Expected " + (this._position - this._buffer.length) + " more bytes. The file might be corrupted. Unexpected end of file."
      );
    }
  }
...
// src/vendor/pickleparser/src/setProvider.ts
var ArraySetProvider = {
  create: () => [],
...
// src/vendor/pickleparser/src/dictionaryProvider.ts
var ObjectDictionaryProvider = {
  create: () => ({}),
  setMethod: function(dict, key, value) {
    dict[key] = value;
  }
};
var StdandardDictionaryProvider = {
  create: () => /* @__PURE__ */ new Map(),
  setMethod: function(dict, key, value) {
    dict.set(key, value);
  }
};
var DictionaryProviderFactory = (type) => {
  switch (type) {
    case "Map":
...
// src/vendor/pickleparser/src/PObject.ts
...
// src/vendor/pickleparser/src/parser.ts
var DefualtOptions = {
  nameResolver: {
  ...
  read(reader) {
    ...
    while (reader.hasNext()) {
      ...
      switch (opcode) {
        ...
        case 97 /* APPEND */: {
          const append2 = stack.pop();
          stack[stack.length - 1].push(append2);
          break;
        }
        case 101 /* APPENDS */: {
          const appends = stack;
...
// src/vendor/zip.js/lib/core/constants.js
...
// src/vendor/zip.js/lib/core/configuration.js
...
// src/vendor/zip.js/lib/core/web-worker-inline-wasm.js
function t(t2) {
  let e;
...
// src/vendor/zip.js/lib/core/streams/codecs/crc32.js
var table = [];
for (let i = 0; i < 256; i++) {
  let t2 = i;
  for (let j = 0; j < 8; j++) {
...
// src/vendor/zip.js/lib/core/streams/crc32-stream.js
...
// src/vendor/zip.js/lib/core/util/encode-text.js
...
// src/vendor/zip.js/lib/core/streams/codecs/sjcl.js
var bitArray = {
  /**
...
// src/vendor/zip.js/lib/core/streams/common-crypto.js
...
// src/vendor/zip.js/lib/core/streams/aes-crypto-stream.js
var BLOCK_LENGTH = 16;
var RAW_FORMAT = "raw";
...
// src/vendor/zip.js/lib/core/streams/zip-crypto-stream.js
...
// src/vendor/zip.js/lib/core/streams/zip-entry-stream.js
...
// src/vendor/zip.js/lib/core/streams/codec-stream.js
...
// src/vendor/zip.js/lib/core/codec-worker.js
...
// src/vendor/zip.js/lib/core/codec-pool.js
var pool = [];
var pendingRequests = [];
var indexWorker = 0;
...
// src/vendor/zip.js/lib/core/io.js
...
// src/vendor/zip.js/lib/core/util/decode-cp437.js
...
// src/vendor/zip.js/lib/core/util/decode-text.js
...
// src/vendor/zip.js/lib/core/zip-entry.js
...
// src/vendor/zip.js/lib/core/options.js
...
// src/vendor/zip.js/lib/core/zip-reader.js
...
// src/vendor/zip.js/lib/core/zip-writer.js
...
// src/vendor/zip.js/lib/zip-core-base.js
try {
  configure({ baseURI: import.meta.url });
} catch {
}

// src/vendor/zip.js/lib/core/zlib-streams-inline.js
...
// src/vendor/zip.js/lib/core/streams/zlib-wasm/zlib-streams.js
var wasm;
var malloc;
var free;
var memory;
...
// src/vendor/zip.js/lib/core/streams/zlib-wasm/zlib-streams-loader.js
...
// src/vendor/zip.js/lib/zip-module-wasm.js
var modulePromise;
g(configure);
configureWorker({
  initModule: (config2) => {
...
// src/vendor/zip.js/lib/core/util/mime-type.js
var table2 = {
  "application": {
    "andrew-inset": "ez",
    "annodex": "anx",
...
// src/vendor/zip.js/lib/zip-fs-wasm.js
t(configure);

// src/serialization/common.ts
var MODEL_FILENAME = "model.json";
async function serializeToZip(obj) {
  ...
  await writer.add(MODEL_FILENAME, new TextReader(jsonStr));
  for (const [id, t2] of tensorMap) {
    const data = await readBuffer(t2.buffer, t2.dtype, t2.numel());
    const bytes = new Uint8Array(data.buffer, data.byteOffset, data.byteLength);
    await writer.add(`tensors/${id}.bin`, new Uint8ArrayReader(bytes));
  }
  await writer.close();
  return blobWriter.getData();
}
async function deserializeFromZip(blob) {
  ...
  let revivedObj;
  if (pklEntry) {
    const pklUint8Data = await pklEntry.getData(new Uint8ArrayWriter());
    ...
    const jsonStr = await jsonEntry.getData(new TextWriter());
    const jsonObj = JSON.parse(jsonStr);
    const tensorEntries = /* @__PURE__ */ new Map();
    ...
    async function reviveJson(obj) {
      if (obj && typeof obj === "object") {
        if (obj.__tensor__ === true) {
          ...
          const uint8Data = await entry.getData(new Uint8ArrayWriter());
          ...
          const t2 = tensor(typedData, { dtype: meta.dtype }).reshape(meta.shape);
...
//# sourceMappingURL=chunk-DTN7IAXQ.js.map